...
async getAllTrainers(req: Request, res: Response): Promise<void> {
    try {
      ...
      const result: PaginatedTrainers = await this.trainerService.getAllTrainers(
        page,
        limit,
        search,
        isBanned,
      ...
      res.status(STATUS_CODE.INTERNAL_SERVER_ERROR).json({ message: "Failed to fetch trainers" });
    }
  }

  async updateTrainer(req: Request, res: Response) {
    try {
        const trainer = await this.trainerService.updateTrainerStatus(req.params.id, req.body);
        res.json(trainer);
    } catch (err:any) {
      res.status(STATUS_CODE.INTERNAL_SERVER_ERROR).json({ message: err.message });
    }
  }
  ...
  async getTrainerApplication(req: Request, res: Response) {
    try {
      const application = await this.trainerService.getTrainerApplication(req.params.id);
  ...
  async getAllUsers(req: Request, res: Response): Promise<void> {
    try {
      ...
      console.error("Controller error:", err);
      res.status(STATUS_CODE.INTERNAL_SERVER_ERROR).json({ message: "Failed to fetch users" });
    }
  }
  ...
  async getUserById(req: Request, res: Response): Promise<void> {
    try {
      ...
      console.error(err);
      res.status(STATUS_CODE.INTERNAL_SERVER_ERROR).json({ message: "Failed to fetch user" });
    }
  }
  ...
  async updateUserStatus(req: Request, res: Response) {
    ...
    const updatedUser = await this.userService.updateUserStatus(id, { isBanned });
    ...
    res.status(STATUS_CODE.INTERNAL_SERVER_ERROR).json({ message: "Failed to update user ban status" });
  }
  }
...
async getGyms(req: Request, res: Response) {
  try {
    ...
    res.status(STATUS_CODE.INTERNAL_SERVER_ERROR).json({ error: "Failed to fetch gyms" });
  }
}
...
async updateGymStatus(req: Request, res: Response) {
  try {
    ...
    res.status(STATUS_CODE.INTERNAL_SERVER_ERROR).json({ error: "Failed to update gym status" });
  }
}
...
async getGymApplication(req: Request, res: Response) {
  try {
    ...
    res.status(STATUS_CODE.INTERNAL_SERVER_ERROR).json({ message: "Failed to fetch gym application" });
  }
}
async verifyGym(req: Request, res: Response) {
  try {
    const { id } = req.params;
    const updatedGym = await this.gymService.updateGymStatus(id, { isVerified: true });
    ...
    res.status(STATUS_CODE.INTERNAL_SERVER_ERROR).json({ message: "Failed to verify gym" });
  }
}
...
async getGymById(req: Request, res: Response) {
  try {
    ...
    res.status(STATUS_CODE.INTERNAL_SERVER_ERROR).json({ error: "Failed to fetch gym" });
  }
}
