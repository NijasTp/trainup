...
export interface IReviewRepository {
    ...
    findByTargetId(targetId: string, skip: number, limit: number, search?: string, rating?: number): Promise<IReview[]>;
    countByTargetId(targetId: string, search?: string, rating?: number): Promise<number>;
