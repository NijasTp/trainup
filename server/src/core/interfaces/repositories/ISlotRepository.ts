...
export interface ISlotRepository {
  ...
  findTrainerSessionsPaginated(trainerId: string, type: 'upcoming' | 'past', page: number, limit: number, date?: string, userId?: string): Promise<{ sessions: ISlot[], total: number }>;
