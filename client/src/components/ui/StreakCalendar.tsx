...
export const StreakCalendar: React.FC<StreakCalendarProps> = ({ sessions }) => {
    ...
    return (
        <div className="w-full max-w-sm mx-auto p-3 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 shadow-lg">
                ...
                {calendarDays.map((day) => {
                    ...
                    return (
                        <div
                            key={dateStr}
                            className={cn(
                                "relative group aspect-square flex items-center justify-center rounded-lg text-xs font-medium transition-all duration-300",
                                !isMonth && "opacity-20",
