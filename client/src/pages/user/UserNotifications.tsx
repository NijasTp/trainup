...
export default function UserNotifications() {
    ...
    const getIcon = (type: string) => {
        ...
        if (type.includes("announcement") || type.includes("promo"))
            return <Megaphone className="h-5 w-5" />;
        if (type.includes("trainer") || type.includes("client"))
                    ...
                    <>
                        <div className="grid gap-4 md:grid-cols-2">
                            {notifications.map((n) => (
                                <Card
                                    key={n._id}
                                    className={`relative overflow-hidden transition-all ${n.isRead ? "opacity-80" : "ring-2 ring-primary/20"
                                        }`}
                                >
                                    {/* Priority Dot */}
                                    <div
                                                ...
                                                <div className="flex justify-between items-start">
                                                    <div>
                                                        ...
                                                        <div className="flex flex-wrap items-center gap-2 mt-1">
                                                            <Badge variant={getCategoryVariant(n.category)}>
                                                                {n.category}
                                                            </Badge>
                                                            {!n.isRead && (
