...
const GymVerifyOtp: React.FC = () => {
    ...
    useEffect(() => {
        if (!formData) {
            toast.error('application data is missing, try again!')
            navigate('/gym/apply');
        }
    }, [formData, navigate]);
    ...
    const handleVerify = async () => {
        ...
        try {
            ...
            dispatch(loginGym({
                ...
                location: res.gym.location, 
                isVerified: res.gym.isVerified
            }));
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-700">
                        <div className="space-y-2 text-sm text-gray-400">
                            <p className="flex items-start gap-2">
                                ...
                                Your gym details have been saved
                            </p>
                            <p className="flex items-start gap-2">
                                <span className="text-green-400 mt-0.5">✓</span>
                                Certificate will be reviewed within 24 hours
                            </p>
                            <p className="flex items-start gap-2">
                                <span className="text-green-400 mt-0.5">✓</span>
