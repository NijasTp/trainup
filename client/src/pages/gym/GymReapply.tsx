...
const GymReapply: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Reapplied successfully. Your status is now pending.');
        ...
        <form onSubmit={handleSubmit} className="space-y-7">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full rounded-lg bg-gray-700 text-white p-3 border ${
          ...
          <div>
            ...
            <div className={`rounded-lg overflow-hidden border ${errors.location ? 'border-red-500' : 'border-gray-600'}`}>
              <LocationForm
